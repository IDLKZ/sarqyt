...
<section>
      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="#welcome" class="menu-item">Шоукейс</a></li>
              <li class="scroll-to-section"><a href="#promotion" class="menu-item">Как это работает</a></li>
              <li class="scroll-to-section"><a href="#testimonials" class="menu-item">Наши партнеры</a></li>
              <li class="scroll-to-section"><a href="#cu" class="menu-item">Стать партнером</a></li>
              <li class="scroll-to-section"><a href="#contact-us" class="menu-item">Контакты</a></li>
            </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
            ...
            <h1><em>Sarqyt App</em> - первый outlet супермаркет в Казахстане!</h1>

            <a href="#promotion" class="main-button-slider">Подробнее</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="promo-clip">
    <div class="container my-5">
      <video-player :allowFullscreen="false" src="/assets/promo-clip.mp4"/>
    </div>
  </div>
  ...
  <div id="cu">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="center-heading">
            <h2>Стать <em>Партнером</em></h2>
            <p>
              Оставьте заявку и наша команда перезвонит Вам!
            </p>
          </div>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 mobile-bottom-fix-big"
          ...
          <form action="">
            <div class="d-md-flex d-lg-flex d-sm-block">
              <input type="text" class="form-control w-75 mr-4 t-input" placeholder="Ваше Имя">
              <input type="text" class="form-control w-75 mr-4 t-input" placeholder="Название Заведения">
              <input type="text" class="form-control w-75 mr-4 t-input" placeholder="Мобильный Телефон">
              <input type="button" class="t-button w-100" value="Оставить заявку">
            </div>
          </form>
        </div>
      </div>
              ...
              <form id="contact" action="" method="post">
                <div class="row">
                  <div class="col-md-12 col-sm-12">
                    <h2>Скачай и используй скидки каждый день!</h2>
                  </div>
                  <div class="col-md-12 col-sm-12 mt-3">
                    Приобретай продукты и получай мгновенный кэшбек вместе с нами
                  </div>
                  <div class="col-md-12 col-sm-12 mt-3">
                    <a href="https://apps.apple.com/kz/app/sarqyt/id1574212112">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.friz.sarqyt_update">
                      <img src="/assets/images/google_play.png" alt="" width="195" height="56">
                    </a>
                  </div>
                </div>
              </form>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="sub-footer">
            <p>Служба поддержки <a rel="nofollow" href="mailto:support@sarqytapp.kz">support@sarqytapp.kz</a></p>
          </div>
        </div>
      </div>
    </div>
